...
var polygon,string1,pointB,groundmain;
...
function setup() {
  ...
  ground2 = new Ground (630,240,200,5);

groundmain = new Ground (400,395,800,10);
...
polygon1 = new Polygon(80,230,20,20);

string1 = new Slingshot(polygon1.body,{x:120,y:230});
